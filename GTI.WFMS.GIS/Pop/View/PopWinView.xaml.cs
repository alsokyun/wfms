...
namespace GTI.WFMS.GIS.Pop.View
{
    ...
    public partial class PopWinView: Window
    {
        ...
        // 생성자
        public PopWinView(string v, string FTR_CDE, string FTR_IDN)
        {
            InitializeComponent();
            ...
            //팝업화면 기본초기화
            this.v = v;
            //this.srcFrm.Tag = FTR_CDE + "," + FTR_IDN;
            BizUtil.FTR_CDE = FTR_CDE;
            BizUtil.FTR_IDN = FTR_IDN;

            //string path = "../../" + v;
            //Uri uri = new Uri(path, UriKind.Relative);
            //this.srcFrm.Source = uri;
            this.srcFrm.Source = new Uri("pack://application:,,,/GTI.WFMS.Modules;component/"+ v, UriKind.Absolute);
