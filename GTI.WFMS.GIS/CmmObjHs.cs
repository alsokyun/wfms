...
namespace GTI.WFMS.GIS
{
    ...
    public class CmmObjHs
    {
        ...
        public static void initLayers()
        {
            ...
            {
                {"view_wtl_flow_ps",  new FeatureLayer()},
                ...
                {"view_wtl_pipe_lm",  new FeatureLayer()},
                {"view_wtl_sply_ls",  new FeatureLayer()},
        ...
        public static void InitUniqueValueRendererObj()
        {
            ...
            uniqueValueRendererObj.AddValue("SAA001", "Name", lineSymbolSA001 as ISymbol);
            uniqueValueRendererObj.set_Symbol("SAA001", lineSymbolSA001 as ISymbol);
            uniqueValueRendererObj.AddValue("SAA003", "Name", lineSymbolSA001 as ISymbol);
            uniqueValueRendererObj.set_Symbol("SAA003", lineSymbolSA001 as ISymbol);
            uniqueValueRendererObj.AddValue("SAA004", "Name", lineSymbolSA001 as ISymbol);
            uniqueValueRendererObj.set_Symbol("SAA004", lineSymbolSA001 as ISymbol);
            uniqueValueRendererObj.AddValue("SAA005", "Name", lineSymbolSA002 as ISymbol);
            uniqueValueRendererObj.set_Symbol("SAA005", lineSymbolSA002 as ISymbol);
        ...
        public static string getLayerKorNm(string layerNm)
        {
            ...
            switch (layerNm)
            {
                ...
                case "WTL_PRGA_PS":
                    korNm = "수압계";
                    break;
                case "view_wtl_flow_ps":
                    korNm = "유량계";
                    break;
                case "view_wtl_sply_ls":
                    korNm = "급수관로";
                    break;
                case "view_wtl_pipe_lm":
                    korNm = "상수관로";
                    break;
                case "WTL_PURI_AS":
                    korNm = "정수장";
