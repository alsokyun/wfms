...
{
    public class UC_SPLY_LSModel : INotifyPropertyChanged
    {
        ...
        private SupDutDtl fctDtl = new SupDutDtl();
        public SupDutDtl FctDtl
        {
            get{ return fctDtl;}
            set
            {
        ...
        private void OnLoaded(object obj)
        {
            try
            {
                ...
                uC_SPLY_LS = obj as UC_SPLY_LS;

                btnSave = uC_SPLY_LS.btnSave;
        ...
        private void OnSave(object obj)
        {
            ...
            if (!BizUtil.ValidReq(uC_SPLY_LS)) return;
            ...
            try
            {
                ...
                BizUtil.Update2(FctDtl, "SaveSupDutDtl");

                //2.위치정보 - 위치편집한 경우만
                if (!FmsUtil.IsNull(GisCmm.WKT_LINE))
                {
                    GisCmm.SavePolyline(FctDtl.FTR_CDE, FctDtl.FTR_IDN.ToString(), "WTL_SPLY_LS");
                    GisCmm.WKT_LINE = "";
                }
        ...
        private void OnDelete(object obj)
        {
            ...
            param.Add("sqlId3", "selectHydtMetrSubList");
            ...
            try
            {
                ...
                if (dt3.Rows.Count > 0)
                {
                    Messages.ShowInfoMsgBox("급수전계량기 내역이 존재합니다.");
                    return;
                }
            }
            catch (Exception) { }
            ...
            // 2.위치정보 삭제처리
            ContentControl cctl = uC_SPLY_LS.Parent as ContentControl;
        ...
        private void InitDataBinding()
        {
            ...
            {
                // cbHJD_CDE 행정동
                BizUtil.SetCombo(uC_SPLY_LS.cbHJD_CDE, "Select_ADAR_LIST", "HJD_CDE", "HJD_NAM", "선택");
                // cbMNG_CDE 관리기관
                BizUtil.SetCmbCode(uC_SPLY_LS.cbMNG_CDE, "250101", "선택");

                // cbSAA_CDE 관용도
                BizUtil.SetCmbCode(uC_SPLY_LS.cbSAA_CDE, "250018", "선택");

                // cbJHT_CDE 접합종류
                BizUtil.SetCmbCode(uC_SPLY_LS.cbJHT_CDE, "250026", "선택");
            }
            catch (Exception ex)
            {
