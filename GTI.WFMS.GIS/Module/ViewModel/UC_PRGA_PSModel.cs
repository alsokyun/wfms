...
{
    public class UC_PRGA_PSModel : INotifyPropertyChanged
    {
        ...
        private void InitDataBinding()
        {
            try
            {
                ...
                // cbPGA_CDE 수압계종류
                BizUtil.SetCmbCode(uC_PRGA_PS.cbPGA_CDE, "PGA_CDE", true);

                // cbMOF_CDE 형식
                BizUtil.SetCmbCode(uC_PRGA_PS.cbMOF_CDE, "MOF_CDE", true, "250035");
