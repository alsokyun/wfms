...
{
    public class UC_FLOW_PSModel : INotifyPropertyChanged
    {
        ...
        private FlowMtDtl fctDtl = new FlowMtDtl();
        public FlowMtDtl FctDtl
        {
            get{ return fctDtl;}
            set
            {
        ...
        private void OnLoaded(object obj)
        {
            try
            {
                ...
                uC_FLOW_PS = obj as UC_FLOW_PS;

                btnSave = uC_FLOW_PS.btnSave;
        ...
        private void OnSave(object obj)
        {
            ...
            if (!BizUtil.ValidReq(uC_FLOW_PS)) return;
        ...
        private void OnDelete(object obj)
        {
            ...
            // 1.삭제처리
            if (Messages.ShowYesNoMsgBox("유량계시설를 삭제하시겠습니까?") != MessageBoxResult.Yes) return;
            try
            {
                BizUtil.Update2(this.FctDtl, "deleteFlowMtDtl");
            }
            catch (Exception)
            {
            ...
            // 2.위치정보 삭제처리
            ContentControl cctl = uC_FLOW_PS.Parent as ContentControl;
        ...
        private void InitModel()
        {
            ...
            FlowMtDtl result = BizUtil.SelectObject(param) as FlowMtDtl;
            if (result != null)
            {
                this.FctDtl = result;
            }
        ...
        private void InitDataBinding()
        {
            ...
            {
                // cbHJD_CDE 행정동
                BizUtil.SetCombo(uC_FLOW_PS.cbHJD_CDE, "Select_ADAR_LIST", "HJD_CDE", "HJD_NAM", "선택");

                // cbMNG_CDE 관리기관
                BizUtil.SetCmbCode(uC_FLOW_PS.cbMNG_CDE, "250101", "선택");

                // cbGAG_CDE 유량계종류
                BizUtil.SetCmbCode(uC_FLOW_PS.cbGAG_CDE, "250061", "선택");

                // cbMOF_CDE 형식
                BizUtil.SetCmbCode(uC_FLOW_PS.cbMOF_CDE, "250035", "선택");
