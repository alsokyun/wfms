...
{
    public class UC_PURI_ASModel : INotifyPropertyChanged
    {
        ...
        private FiltPltDtl fctDtl = new FiltPltDtl();
        public FiltPltDtl FctDtl
        {
            get{ return fctDtl;}
            set
            {
        ...
        private void OnLoaded(object obj)
        {
            try
            {
                ...
                uC_PURI_AS = obj as UC_PURI_AS;

                btnSave = uC_PURI_AS.btnSave;
        ...
        private void OnSave(object obj)
        {
            ...
            if (!BizUtil.ValidReq(uC_PURI_AS)) return;
            ...
            try
            {
                ...
                BizUtil.Update2(FctDtl, "SaveFiltPltDtl");
            }
            catch (Exception e)
            {
        ...
        private void OnDelete(object obj)
        {
            ...
            try
            {
                BizUtil.Update2(this.FctDtl, "deleteFiltPltDtl");
            }
            catch (Exception)
            {
        ...
        private void InitModel()
        {
            ...
            FiltPltDtl result = BizUtil.SelectObject(param) as FiltPltDtl;
            if (result != null)
            {
                this.FctDtl = result;
            }
        ...
        private void InitDataBinding()
        {
            ...
            {
                // cbHJD_CDE 행정동
                BizUtil.SetCombo(uC_PURI_AS.cbHJD_CDE, "Select_ADAR_LIST", "HJD_CDE", "HJD_NAM", true);

                // cbMNG_CDE 관리기관
                BizUtil.SetCmbCode(uC_PURI_AS.cbMNG_CDE, "MNG_CDE", true);

                // cbWSR_CDE 수원구분
                BizUtil.SetCmbCode(uC_PURI_AS.cbWSR_CDE, "WSR_CDE", true);

                // cbSAM_CDE 여과방법
                BizUtil.SetCmbCode(uC_PURI_AS.cbSAM_CDE, "SAM_CDE", true);
