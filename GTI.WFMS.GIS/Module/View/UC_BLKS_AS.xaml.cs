...
namespace GTI.WFMS.GIS.Module.View
{
    ...
    /// </summary>
    public partial class UC_BLKS_AS : UserControl
    {
        //생성자
        public UC_BLKS_AS()
        {
        ...
        //시설물 상세 생성자
        public UC_BLKS_AS(string _FTR_CDE, string _FTR_IDN) : this()
        {
        ...
        //신규 시설물 생성자
        public UC_BLKS_AS(string _FTR_CDE) : this()
        {
            txtFTR_CDE.Text = _FTR_CDE;
            
            //신규관리번호채번
            Hashtable param = new Hashtable();
            param.Add("sqlId", "SelectBlk03FTR_IDN");
