...
{
    /// <summary>
    /// UC_HEAD_PS.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class UC_HEAD_PS : UserControl
    {
        //생성자
        public UC_HEAD_PS()
        {
        ...
        //시설물 상세 생성자
        public UC_HEAD_PS(string _FTR_CDE, string _FTR_IDN) : this()
        {
        ...
        //신규 시설물 생성자
        public UC_HEAD_PS(string _FTR_CDE) : this()
        {
            txtFTR_CDE.Text = _FTR_CDE;
