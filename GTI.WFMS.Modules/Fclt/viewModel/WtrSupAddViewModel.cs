...
{
    public class WtrSupAddViewModel : WtrSupDtl
    {
        ...
        private void OnLoaded(object obj)
        {
            try
            {
                ...
                wtrSupAddView = values[0] as WtrSupAddView;
               // cbFTR_CDE = wtrSupAddView.cbFTR_CDE;     //지형지물
                cbHJD_CDE = wtrSupAddView.cbHJD_CDE;       //행정동
                cbMNG_CDE = wtrSupAddView.cbMNG_CDE;       //관리기관
                cbSAG_CDE = wtrSupAddView.cbSAG_CDE;       //관리방법
                cbSCW_CDE = wtrSupAddView.cbSCW_CDE;       //배수지제어방법

                btnBack = wtrSupAddView.btnBack;
                btnSave = wtrSupAddView.btnSave;
                ...
                param.Add("sqlId", "SelectWtrSupFTR_IDN");
        ...
        private void OnSave(object obj)
        {
            ...
            if (!BizUtil.ValidReq(wtrSupAddView)) return;
