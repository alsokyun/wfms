...
{
    /// <summary>
    /// WtrSupDtlView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class WtrSupDtlView : Page
    {
        ...
        public WtrSupDtlView(string FTR_CDE, int FTR_IDN)
        {
            InitializeComponent();
        ...
        {
            NavigationService.Navigate(new WtrSupListView());
        }
