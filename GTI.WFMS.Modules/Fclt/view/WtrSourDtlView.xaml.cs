...
{
    /// <summary>
    /// WtrSourDtlView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class WtrSourDtlView : Page
    {
        ...
        public WtrSourDtlView(string FTR_CDE, int FTR_IDN)
        {
            InitializeComponent();
        ...
        {
            NavigationService.Navigate(new WtrSourListView());
        }
