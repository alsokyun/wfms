...
{
    /// <summary>
    /// HydtMetrDtlView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class HydtMetrDtlView : Page
    {
        ...
        public HydtMetrDtlView(string FTR_CDE, int FTR_IDN)
        {
            _FTR_CDE = FTR_CDE;
            _FTR_IDN = FTR_IDN;
        ...
        {
            NavigationService.Navigate(new HydtMetrListView());
        }
