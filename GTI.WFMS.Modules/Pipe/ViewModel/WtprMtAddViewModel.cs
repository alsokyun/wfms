...
{
    public class WtprMtAddViewModel : WtprMtDtl
    {
        ...
        private void OnLoaded(object obj)
        {
            try
            {
                ...
                wtprMtAddView = values[0] as WtprMtAddView;
               // cbFTR_CDE = wtprMtAddView.cbFTR_CDE;     //지형지물
                cbHJD_CDE = wtprMtAddView.cbHJD_CDE;       //행정동
                cbMNG_CDE = wtprMtAddView.cbMNG_CDE;       //관리기관
                cbPGA_CDE = wtprMtAddView.cbPGA_CDE;       //수압계종류
                cbMOF_CDE = wtprMtAddView.cbMOF_CDE;       //유형

                btnBack = wtprMtAddView.btnBack;
                btnSave = wtprMtAddView.btnSave;
        ...
        private void OnSave(object obj)
        {
            ...
            if (!BizUtil.ValidReq(wtprMtAddView)) return;
        ...
        private void InitDataBinding()
        {
            try
            {
                ...
                // cbPGA_CDE 수압계종류
                BizUtil.SetCmbCode(cbPGA_CDE, "250057", true);
