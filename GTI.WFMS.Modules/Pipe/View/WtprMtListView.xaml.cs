...
{
    /// <summary>
    /// WtprMtListView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class WtprMtListView : Page
    {
        public WtprMtListView()
        {
            InitializeComponent();
        ...
        private void TableView_RowDoubleClick(object sender, RowDoubleClickEventArgs e)
        {
            ...
            try
            {
                ...
                NavigationService.Navigate(new WtprMtDtlView(FTR_CDE, FTR_IDN));
            }
            catch (Exception ex)
            {
        ...
        {            
            NavigationService.Navigate(new WtprMtAddView());
        }
