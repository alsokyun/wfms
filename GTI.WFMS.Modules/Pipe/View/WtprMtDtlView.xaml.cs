...
{
    /// <summary>
    /// WtprMtDtlView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class WtprMtDtlView : Page
    {
        ...
        public WtprMtDtlView(string FTR_CDE, int FTR_IDN)
        {
            InitializeComponent();
        ...
        {
            NavigationService.Navigate(new WtprMtListView());
        }
