...
{
    /// <summary>
    /// ValvFacDtlView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class ValvFacDtlView : Page
    {
        ...
        public ValvFacDtlView(string FTR_CDE, int FTR_IDN)
        {
            InitializeComponent();
        ...
        {
            NavigationService.Navigate(new ValvFacListView());
        }
