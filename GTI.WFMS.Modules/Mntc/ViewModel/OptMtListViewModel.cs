...
{
    public class OptMtListViewModel : INotifyPropertyChanged
    {
        ...
        private void OnLoaded(object obj)
        {
            ...
            //1. 화면객체 인스턴스
            optMtListView = obj as OptMtListView;
        ...
        private void SearchAction(object obj)
        {
            try
            {
                ...
                conditions.Add("sqlId", "SelectOptMtList");
        ...
        private void ExcelDownAction(object obj)
        {
            ...
            try
            {
                ...
                //초기 파일명 지정
                saveFileDialog.FileName = DateTime.Now.ToString("yyyyMMdd") + "_" + "시설물가동현황.xlsx";
        ...
        private void ExcelExportFX()
        {
            try
            {
                ...
                ExcelUtil.ExcelGrid(strExcelFormPath, strFileName, "시설물가동현황", dtExceltTableData, tablePointXY, grid, true);
