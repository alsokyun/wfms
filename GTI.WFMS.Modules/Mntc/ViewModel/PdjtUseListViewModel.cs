...
{
    public class PdjtUseListViewModel : INotifyPropertyChanged
    {
        ...
        PdjtUseListView pdjtUseListView;
        ...
        private void OnLoaded(object obj)
        {
            ...
            //1. 화면객체 인스턴스
            pdjtUseListView = obj as PdjtUseListView;
        ...
        private void SearchAction(object obj)
        {
            try
            {
                ...
                try
                {
                    ...
                    conditions.Add("END_YMD", dtEND_YMD.EditValue == null ? null : Convert.ToDateTime(dtEND_YMD.EditValue).ToString("yyyy-MM-dd"));
                }
                catch (Exception) { }
        ...
        private void ExcelExportFX()
        {
            try
            {
                pdjtUseListView.Dispatcher.Invoke(DispatcherPriority.ApplicationIdle,
                    new Action((delegate ()
                    {
                        (pdjtUseListView.FindName("waitindicator") as WaitIndicator).DeferedVisibility = true;
                    })));
                ...
                pdjtUseListView.Dispatcher.Invoke(DispatcherPriority.ApplicationIdle,
                   new Action((delegate ()
                   {
                       (pdjtUseListView.FindName("waitindicator") as WaitIndicator).DeferedVisibility = false;
