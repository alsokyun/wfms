...
{
    public class UcChart07Model : DashDtl
    {
        ...
        private void OnLoaded(object obj)
        {
            try
            {
                ...
                //1. 화면객체 인스턴스
                ucChart07 = values[0] as UcChart07;
                ...
                param.Add("sqlId", "SelectDashChart7List");
                param.Add("pYm", sYm);
