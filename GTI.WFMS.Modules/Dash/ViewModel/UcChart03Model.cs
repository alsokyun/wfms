...
{
    public class UcChart03Model : DashDtl
    {
        ...
        private void OnLoaded(object obj)
        {
            try
            {
                ...
                //1. 화면객체 인스턴스
                ucChart03 = values[0] as UcChart03;
                ...
                param.Add("sqlId", "SelectDashChart3List");
                param.Add("pYm", sYm);
