...
{
    /// <summary>
    /// WtrTrkHtDtlView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class WtrTrkHtDtlView: Window
    {

        // 생성자
        public WtrTrkHtDtlView( string _FTR_CDE, int _FTR_IDN, int _SEQ)
        {
            InitializeComponent();
        ...
        private void WtrTrkHtDtlView_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.Key == Key.Escape)
            {
                this.Close();
