...
{
    /// <summary>
    /// Blk03DtlView.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class Blk03DtlView : Page
    {
        ...
        public Blk03DtlView(string FTR_CDE, int FTR_IDN)
        {
            _FTR_CDE = FTR_CDE;
            _FTR_IDN = FTR_IDN;
        ...
        {
            NavigationService.Navigate(new Blk03ListView());
        }
